...
return [
    ...
    */
    ...
    'remove' => [
        ...
        ClassStructureSniff::class, // Ignores strict ordering like forcing casts() to the bottom
        DeclareStrictTypesSniff::class,
        DisallowArrayTypeHintSyntaxSniff::class, // Allows WorkoutSet[] in docblocks
        DisallowMixedTypeHintSniff::class,
        ForbiddenDefineFunctions::class,
        ForbiddenNormalClasses::class,
        ForbiddenTraits::class,
        LineLengthSniff::class, // Removes the archaic 80-character limit
